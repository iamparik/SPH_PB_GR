subroutine ScalarGradientPtoP(delF_a,delF_b,a,b,F_a,F_b,Cdwdx_a, Cdwdx_b, mass_a, mass_b, rho_a, rho_b, dim , divType)
    ...
    do d= 1,dim
        call DerivativeOperator(delF_a(d),delF_b(d),a,b,F_a,F_b,Cdwdx_a(d), Cdwdx_b(d), mass_a, mass_b, rho_a, rho_b, divType)
    enddo

end 

subroutine ScalarGradientPtoB(delF_a,a,s,F_a,F_s,Cdgmas,dim, divType)
    ...
    do d= 1,dim
        call DerivativeOperatorB(delF_a(d),a,s,F_a,F_s,Cdgmas(d), divType)
    enddo
