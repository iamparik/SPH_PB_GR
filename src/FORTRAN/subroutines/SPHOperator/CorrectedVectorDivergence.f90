subroutine CorrectedVecDivPtoP(divF_a,divF_b,a,b,F_a,F_b,dwdx, mass_a, mass_b, rho_a, rho_b, &
    ...
    implicit none
    integer(4), intent(in) :: dim, CF_ID, div_type,a,b
    ...
    call VectorDivergencePtoP(divF_a,divF_b,a,b,F_a,F_b,Cdwdx_a, Cdwdx_b, mass_a, mass_b, rho_a, rho_b, dim, div_type)
    
endsubroutine
    


subroutine CorrectedVecDivPtoB(divF_a,a,s,F_a,F_b,del_gamma_as,&
                    & gamma_cont_a, gamma_discrt_a, gamma_mat_a, gamma_mat_inv_a, xi1_mat_inv_a, &
    ...
    implicit none
    integer(4), intent(in) :: dim, CF_ID, div_type,a,s
    ...
    call VectorDivergencePtoB(divF_a,a,s,F_a,F_b,Cdgmas, dim, div_type)
