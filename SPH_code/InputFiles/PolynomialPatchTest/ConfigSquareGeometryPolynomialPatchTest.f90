...
!****************************************************************************
    ...
    module config_parameter
        ...
        integer(4),parameter :: save_step = 1000
...
!   Last Modified:  08/24/2022       by  PARIKSHIT BOREGOWDA 
!****************************************************************************
    ...
    module config_geometry
        ...
        real(8) ::  dx_r != width/(dble(npw) + bt_dx_r*2.D0)
        integer(4) ::  npl !=nint(length/dx_r)        
        ...
        real(8), parameter ::   c_sound = 1.D-2 !20.D0
        real(8), parameter ::   g_const = 0.D0!9.81D0 
        real(8), dimension(:), allocatable ::   F_ext !5.D-5   
        real(8), parameter ::   C_shift = 0.7D0      
        integer(4), parameter ::   NumericalSimCase=0 !if unknown or relError Calcualtion is to be avoided type 0
        integer(4) ::    BILtype=0
