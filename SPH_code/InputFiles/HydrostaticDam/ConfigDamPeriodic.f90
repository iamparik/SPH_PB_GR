...
!****************************************************************************
    ...
    module config_parameter
        ...
        integer(4),parameter :: print_step = 1
        integer(4),parameter :: save_step = 1
...
!****************************************************************************
    ...
    module config_geometry
        ...
        public time_step
        real(8),parameter ::  time_step=4.D-4
        
        public npw,npl,width,length,dx_r, bt_dx_r
        real(8), parameter :: width = 5.D-1
        real(8), parameter :: length= 1.D-1
        ...
        public hsml_const,rho_init, mu_const, c_sound, g_const, F_ext, C_shift, &
            & NumericalSimCase, BILtype, PrsrGradtype, ConDivtype, timeIntegrationScheme,&
            & SumDenstype, summationDensity, artViscType, MLS_density_bound, MLS_step, &
            & densDiffType, delta_SPH
        real(8), parameter ::   hsml_const=dx_r*2.D0
        real(8), parameter ::   rho_init=1000.D0
        real(8), parameter ::   mu_const = 1.D1!1.D-3   
        real(8), parameter ::   c_sound = 20.D0!1.D-3 !20.D0
        real(8), parameter ::   g_const = 9.81D0 
        real(8), dimension(:), allocatable ::   F_ext !5.D-5   
        real(8), parameter ::   C_shift = 0.7D0      
        integer(4), parameter ::   NumericalSimCase=4 !if unknown or relError Calcualtion is to be avoided type 0
        integer(4), parameter ::   timeIntegrationScheme=1
        integer(4) ::    BILtype= 0! 10
        integer(4), parameter ::    PrsrGradtype=9
        integer(4), parameter ::    ConDivtype=8 !8
        integer(4), parameter ::  SumDenstype=3
        logical,parameter :: summationDensity=.false.
        integer(4), parameter :: artViscType=0 !1
        logical,parameter ::  MLS_density_bound= .false.
        integer(4),parameter :: MLS_step = 1 !40 ! change to 20
        integer(4), parameter :: densDiffType=2
        real(8), parameter ::   delta_SPH = 0.1D0 
