        ...
        MODULE GRADIENTKCBI_CSPM__genmod
          INTERFACE 
            SUBROUTINE GRADIENTKCBI_CSPM(D1F,F0,XI_INV,SPH_DIM,NIAC,    &
     ...
     &NUM_EDGES)
            ...
            END SUBROUTINE GRADIENTKCBI_CSPM
          END INTERFACE 
        END MODULE GRADIENTKCBI_CSPM__genmod
