        ...
        MODULE LAPLACIANBIL_MACIA__genmod
          INTERFACE 
            SUBROUTINE LAPLACIANBIL_MACIA(LAPF,F0,FS0,X,XS,GMA,SPH_DIM, &
     &NIAC,PAIR_I,PAIR_J,DWDX,ENIAC,EPAIR_A,EPAIR_S,DGMAS,MASS,RHO,ITYPE&
     &,NTOTAL,ETOTAL)
            ...
            END SUBROUTINE LAPLACIANBIL_MACIA
          END INTERFACE 
        END MODULE LAPLACIANBIL_MACIA__genmod
