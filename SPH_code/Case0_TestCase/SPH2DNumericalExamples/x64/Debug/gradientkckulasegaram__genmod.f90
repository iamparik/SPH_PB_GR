        ...
        MODULE GRADIENTKCKULASEGARAM__genmod
          INTERFACE 
            SUBROUTINE GRADIENTKCKULASEGARAM(D1F,F0,FS0,GMA,SPH_DIM,NIAC&
     &,PAIR_I,PAIR_J,DWDX,ENIAC,EPAIR_A,EPAIR_S,DGMAS,MASS,RHO,RHOS,    &
     &ITYPE,NTOTAL,NUM_EDGES)
            ...
            END SUBROUTINE GRADIENTKCKULASEGARAM
          END INTERFACE 
        END MODULE GRADIENTKCKULASEGARAM__genmod
