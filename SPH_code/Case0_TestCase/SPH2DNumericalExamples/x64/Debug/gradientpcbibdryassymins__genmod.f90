        !COMPILER-GENERATED INTERFACE MODULE: Mon Dec  4 12:45:25 2023
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE GRADIENTPCBIBDRYASSYMINS__genmod
          INTERFACE 
            SUBROUTINE GRADIENTPCBIBDRYASSYMINS(D1F,F0,FS0,GMA,GMA_INV, &
     ...
     &)
            ...
            END SUBROUTINE GRADIENTPCBIBDRYASSYMINS
          END INTERFACE 
        END MODULE GRADIENTPCBIBDRYASSYMINS__genmod
