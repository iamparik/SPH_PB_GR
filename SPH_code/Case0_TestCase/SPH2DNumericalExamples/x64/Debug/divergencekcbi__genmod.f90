        ...
        MODULE DIVERGENCEKCBI__genmod
          INTERFACE 
            SUBROUTINE DIVERGENCEKCBI(D1F,F0,FS0,GMA,SPH_DIM,NIAC,PAIR_I&
     ...
     &NUM_EDGES)
            ...
            END SUBROUTINE DIVERGENCEKCBI
          END INTERFACE 
        END MODULE DIVERGENCEKCBI__genmod
