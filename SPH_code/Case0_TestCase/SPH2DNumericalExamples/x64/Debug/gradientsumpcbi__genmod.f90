        ...
        MODULE GRADIENTSUMPCBI__genmod
          INTERFACE 
            SUBROUTINE GRADIENTSUMPCBI(D1F,F0,FS0,GMA_INV,SPH_DIM,NIAC, &
     ...
     &)
            ...
            END SUBROUTINE GRADIENTSUMPCBI
          END INTERFACE 
        END MODULE GRADIENTSUMPCBI__genmod
