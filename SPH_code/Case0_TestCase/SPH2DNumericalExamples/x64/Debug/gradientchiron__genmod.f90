        ...
        MODULE GRADIENTCHIRON__genmod
          INTERFACE 
            SUBROUTINE GRADIENTCHIRON(D1F,F0,FS0,GMA,SPH_DIM,NIAC,PAIR_I&
     &,PAIR_J,DWDX,ENIAC,EPAIR_A,EPAIR_S,DGMAS,MASS,RHO,RHOS,ITYPE,     &
     &NTOTAL,NUM_EDGES)
            ...
            END SUBROUTINE GRADIENTCHIRON
          END INTERFACE 
        END MODULE GRADIENTCHIRON__genmod
