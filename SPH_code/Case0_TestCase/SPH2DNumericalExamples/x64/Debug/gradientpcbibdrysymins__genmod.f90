        ...
        MODULE GRADIENTPCBIBDRYSYMINS__genmod
          INTERFACE 
            SUBROUTINE GRADIENTPCBIBDRYSYMINS(D1F,F0,FS0,GMA,GMA_INV,   &
     ...
     &)
            ...
            END SUBROUTINE GRADIENTPCBIBDRYSYMINS
          END INTERFACE 
        END MODULE GRADIENTPCBIBDRYSYMINS__genmod
