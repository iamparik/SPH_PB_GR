        ...
        MODULE GRADIENTKULASEGARAM__genmod
          INTERFACE 
            SUBROUTINE GRADIENTKULASEGARAM(D1F,F0,FS0,GMA,SPH_DIM,NIAC, &
     &PAIR_I,PAIR_J,DWDX,ENIAC,EPAIR_A,EPAIR_S,DGMAS,MASS,RHO,RHOS,ITYPE&
     &,NTOTAL,NUM_EDGES)
            ...
            END SUBROUTINE GRADIENTKULASEGARAM
          END INTERFACE 
        END MODULE GRADIENTKULASEGARAM__genmod
