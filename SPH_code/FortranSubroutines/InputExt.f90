...
!****************************************************************************
    ...
    subroutine inputExt(maxTimeStep)
        
    use config_parameter, only: etype_periodic, etype_SolidWall1, etype_SolidWall2, &
    ...
    use config_geometry, only: SPH_dim, dx_r, hsml_const,hydrostaticHeight, rho_init, mu_const, &
    ...
    maxnv=3*maxedge
    additionalParticles= 100 ! This is necessary only if expect to use periodic particles, or inflow, outflow particles
