...
subroutine ICinputValue(initalVal_particle,num_var, itype)
    ...
    if(itype .eq. 3) then
        ...
        initalVal_particle(5)= rho_init*((7.D0*9.81D0*(0.5D0-initalVal_particle(2))/(c_sound**2)+1.D0)**(1.D0/7.D0)) ! density
        initalVal_particle(6)= (rho_init*c_sound**2/7.D0)*((initalVal_particle(5)/rho_init)**7.D0-1.D0) !pressur
