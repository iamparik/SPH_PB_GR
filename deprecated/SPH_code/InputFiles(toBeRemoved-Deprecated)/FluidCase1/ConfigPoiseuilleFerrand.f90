...
!****************************************************************************
    ...
    module config_geometry
        ...
        real(8), parameter ::   mu_const = 1.D2!1.D-3   
        real(8), parameter ::   c_sound = 1.D1 !20.D0
        real(8), parameter ::   g_const = 0.D0!9.81D0 
        real(8), dimension(:), allocatable ::   F_ext !5.D-5   
        real(8), parameter ::   C_shift = 0.7D0      
        integer(4), parameter ::   NumericalSimCase=3 !if unknown or relError Calcualtion is to be avoided type 0
        integer(4) ::    BILtype=0
        integer(4), parameter ::    PrsrGradtype=2
        integer(4), parameter ::    ConDivtype=2
    end module