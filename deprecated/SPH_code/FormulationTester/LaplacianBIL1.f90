...
subroutine LaplacianBIL1(lapf, f0, df0, x, gma, SPH_dim, niac, pair_i, pair_j, dwdx, eniac, epair_a, epair_s, dgmas, mass, rho, itype, ntotal, etotal)
    implicit none
    ...
    real(8), intent(in):: df0(SPH_dim,ntotal),  x(SPH_dim,ntotal)
