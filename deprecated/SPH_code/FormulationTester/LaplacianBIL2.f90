...
subroutine LaplacianBIL2(lapf, f0, df0, dfs0, x, gma, SPH_dim, niac, pair_i, pair_j, dwdx, eniac, epair_a, epair_s, dgmas, mass, rho, itype, ntotal, etotal)
    implicit none
