...
subroutine BIL2Corrected(lapf, dfs0, Gma_inv, SPH_dim, eniac, epair_a, epair_s, dgmas, etype, etotal, ntotal, coeff)
    implicit none
    ...
    !  2/𝛾_𝑎 ∑_𝑠〖( 𝛁𝑓_𝑎)∙𝛁𝛾_𝑎𝑠〗 
     do k= 1, eniac
        ...
        do d=1,SPH_dim
            lap_coeff= - coeff*dfs0(d,s)*Cdgmas(d)
        ...
        !    do d=1,SPH_dim
        !        lap_coeff=2.D0*dfs0(d,s)*dgmas(d,k)
        !        call fncnApproxOperator(lapf(a),lap_coeff,1.D0,1.D0,-1.D0/gma(a))
        !    enddo
        !endif       
